const CACHE="silverback-v3-cache-v7";
const ASSETS=["./","./index.html","./styles.css","./app.js","./importer.js","./bulk.js","./groups.js","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png"];
