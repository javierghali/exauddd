const CACHE="silverback-v3-cache-v10";
const ASSETS=["./","./index.html","./styles.css","./app.js","./importer.js","./bulk.js","./groups.js","./status.js","./status-bulk.js","./bulk-delete.js","./navigation.js","./bulk-group.js","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png"];
