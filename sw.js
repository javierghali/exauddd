const CACHE="silverback-v3-cache-v8";
const ASSETS=["./","./index.html","./styles.css","./app.js","./importer.js","./bulk.js","./groups.js","./status.js","./status-bulk.js","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png"];
